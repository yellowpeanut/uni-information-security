...
import codecs
import random
from ElGammalCoder import ElGammalCoder
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lbPubK0.setGeometry(QtCore.QRect(530, 60, 241, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbChunkSize.setText(_translate("MainWindow", "Размер блока шифрования"))
        self.lbPubK0.setText(_translate("MainWindow", "Публичный ключ: p"))
    ...
    def decrypt(self):
        ...
        chunkSize = int(self.leChunkSize.text())+1
        pub_k = [int(self.lePubK0.text()), int(self.lePubK1.text())]
        priv_k = int(self.lePrivK.text())
        decryptedText = coder.decrypt(pub_k, priv_k, message, chunkSize)
        # 188030234236081030235030083030159236222098030137236222030116088236222030116236222088236016030213030246236179030170088030051030235236081030213236222023
